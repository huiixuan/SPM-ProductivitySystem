    ...
    useEffect(() => {
        ...
        fetch("http://127.0.0.1:5000/auth/dashboard", {
            ...
            .then((data) => {
                ...
                if (role === "staff") setDashboard("This is the Staff Dashboard");
                else if (role === "hr") setDashboard("This is the HR Dashboard");
                else if (role === "manager") setDashboard("This is the Manager Dashboard");
                else if (role === "director") setDashboard("This is the Director Dashboard");
